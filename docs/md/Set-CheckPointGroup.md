...
```
Set-CheckPointGroup -Group <PSObject> [-GroupAction <MembershipActions>] [-Groups <String[]>]
 [-MemberAction <MembershipActions>] [-Members <String[]>] [-NewName <String>] [-TagAction <MembershipActions>]
