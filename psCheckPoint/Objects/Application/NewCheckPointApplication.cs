...
namespace psCheckPoint.Objects.Application
{
    ...
    public class NewCheckPointApplication : NewCheckPointObject
    {
        ...
        public string[] AdditionalCategories { get { return _additionalCategories; } set { _additionalCategories = CreateArray(value); } }
        ...
        public string[] ApplicationSignature { get { return _applicationSignatures; } set { _applicationSignatures = CreateArray(value); } }
        ...
        public string[] UrlList { get { return _urls; } set { _urls = CreateArray(value); } }
        ...
        protected override bool UpdateProperty(IObjectSummary obj, string name, object value)
        {
            ...
            switch (name)
            {
                case nameof(AdditionalCategories):
                    foreach (var c in AdditionalCategories ?? Enumerable.Empty<string>())
                        o.AdditionalCategories.Add(c);
                    return true;

                case nameof(ApplicationSignature):
                    foreach (var s in ApplicationSignature ?? Enumerable.Empty<string>())
                ...
                case nameof(UrlList):
                    foreach (var u in UrlList ?? Enumerable.Empty<string>())
                        o.UrlList.Add(u);
                    return true;
